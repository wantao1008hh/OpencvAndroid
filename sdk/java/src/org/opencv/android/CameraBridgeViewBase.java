...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
     ...
     */
    protected Size calculateCameraFrameSize(List<?> supportedSizes, final ListItemAccessor accessor, int surfaceWidth, int surfaceHeight) {
        int calcWidth = 0;
        int calcHeight = 0;
        ...
        Collections.sort(supportedSizes, new Comparator<Object>() {
            @Override
            public int compare(Object o, Object t1) {
                return accessor.getWidth(o)-accessor.getWidth(t1);
            }
        });
